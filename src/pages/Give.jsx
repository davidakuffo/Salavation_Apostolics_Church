    ...
    <section className="bg-white">
      ...
      <div className="container mx-auto mt-16 grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[2rem] bg-gray-50 p-10 shadow-soft">
          <p className="text-sm uppercase tracking-[0.3em] text-amber-700">Why give</p>
          ...
          <div className="mt-10 space-y-6">
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              <p className="text-sm uppercase tracking-[0.3em] text-amber-700">Scripture</p>
          ...
          <a
            ...
            className="mt-10 inline-flex items-center justify-center rounded-full bg-amber-500 px-8 py-3 text-sm font-semibold text-primary transition hover:bg-amber-400"
          >
            Give Now
          </a>
        </div>
